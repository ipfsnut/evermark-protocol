...
// Removed Solana imports - using Base chain only
...
// Removed Solana components - using Base chain only
...
export function WalletTab() {
  ...
  // Removed Solana wallet hooks - using Base chain only
  ...
  return (
    <div className="space-y-3 px-6 w-full max-w-md mx-auto">
      ...
      {/* Removed Solana wallet components - using Base chain only */}
    </div>
  );
} 